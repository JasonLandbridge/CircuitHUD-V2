...
function gui_settings.create(player_index)
							...
							children = {
								...
								-- Uncollapse HUD on new combinator
								{
									...
									children = {
										...
										{
											type = "checkbox",
											state = player_settings.get_uncollapse_hud_on_register_combinator_setting(
												player_index),
											style_mods = {
												top_margin = 8
											},
	...
	player_data.set_hud_element_ref(player_index, const.HUD_NAMES.settings_hud_columns_slider,
		refs[const.HUD_NAMES.settings_hud_columns_slider])
	player_data.set_hud_element_ref(player_index, const.HUD_NAMES.settings_hud_columns_value,
		refs[const.HUD_NAMES.settings_hud_columns_value])

	player_data.set_hud_element_ref(player_index, const.HUD_NAMES.settings_hud_height_slider,
		refs[const.HUD_NAMES.settings_hud_height_slider])
	player_data.set_hud_element_ref(player_index, const.HUD_NAMES.settings_hud_height_value,
		refs[const.HUD_NAMES.settings_hud_height_value])
	...
	player_data.set_hud_element_ref(player_index, const.HUD_NAMES.settings_hud_refresh_rate_value,
		refs[const.HUD_NAMES.settings_hud_refresh_rate_value])
